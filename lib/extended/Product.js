...
var Product = function () {
  ...
  _createClass(Product, [{
    ...
    value: function create() {
      ...
      var manifestData = (0, _.generateManifest)({ name: this.name });

      (0, _.createFile)({ root: this.dir, filepath: 'package.json', data: packageData, json: true });
      (0, _.createFile)({ root: this.dir, filepath: 'chunky.json', data: manifestData, json: true });

      (0, _.installTemplate)({ dir: this.dir, home: this.home, template: this.template });

      (0, _.updateChunksIndex)(this.dir);
    }
  }, {
    key: 'props',
    get: function get() {
