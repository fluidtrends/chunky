...
function cacheAuth(data) {
  var newData = Object.assign({}, data, data.user && data.user.stsTokenManager && { access: data.user.stsTokenManager });
  return (0, _generic.cacheItem)(Config.AUTH_CACHE_KEY, newData);
}
