  ...
  _createClass(FirebaseDataProvider, [{
    ...
    value: function login(_ref2) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        // Attempt to sign in
        return _firebaseline.operations.login(firebase, { email: email, password: password }).then(function (user) {
          return (0, _cache.cacheAuth)({ user: user });
        }).then(function (auth) {
    ...
    value: function register(_ref3) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        return _firebaseline.operations.register(firebase, Object.assign({ appAuth: true }, props)).then(function () {
