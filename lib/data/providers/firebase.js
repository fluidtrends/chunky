  ...
  _createClass(FirebaseDataProvider, [{
    ...
    value: function login(_ref2) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        // Attempt to sign in
        return _firebaseline.operations.login(firebase, { email: email, password: password }).then(function (account) {
          firebase.auth().onAuthStateChanged(function (user) {
            var combined = Object.assign({}, {
              uid: user.uid,
              emailVerified: user.emailVerified
            }, account);
            (0, _cache.cacheAuth)({ user: combined }).then(function () {
    ...
    value: function register(_ref3) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        return _firebaseline.operations.register(firebase, Object.assign({ appAuth: true }, props)).then(function (account) {
          firebase.auth().onAuthStateChanged(function (user) {
            var combined = Object.assign({}, {
              uid: user.uid,
              emailVerified: user.emailVerified
