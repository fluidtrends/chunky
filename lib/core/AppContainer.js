...
var AppContainer = function (_Component) {
  ...
  function AppContainer(props) {
    ...
    _this._initializeDataProviders(_data.Providers);

    // Setup all the custom data providers
    _this._initializeDataProviders(_this.props.providers);
    ...
    _this.state = { store: (0, _store2.default)(_this.reducers, { logging: props.env === 'dev' })
  ...
  _createClass(AppContainer, [{
    ...
    value: function _initializeDataProviders(pool) {
      var _this2 = this;
      ...
      supportedProviders.forEach(function (providerName) {
        ...
        var provider = new pool[providerName](providerOptions);
