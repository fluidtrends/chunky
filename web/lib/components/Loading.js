...
function (_Component) {
  ...
  function LoadingComponent(props) {
    ...
    _this.state = _objectSpread({}, _get(_getPrototypeOf(LoadingComponent.prototype), "state", _assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(LoadingComponent, [{
    ...
    value: function render() {
      ...
      var indicator = _react["default"].createElement(_antd.Icon, {
        type: "loading",
        style: {
          fontSize: 48,
          color: '#039BE5'
