...
var Navigation = function (_PureComponent) {
  ...
  _createClass(Navigation, [{
    ...
    value: function renderNavigationLogo() {
      ...
      return (0, _responsive.renderResponsive)('logo', _react2.default.createElement(_Toolbar.ToolbarMenuIcon, { use: 'menu', style: { color: this.props.theme.navigationTintColor }, onClick: this._onMenuOpen }), _react2.default.createElement('img', { src: '/assets/' + image, style: { height: height + 'px', marginLeft: '20px' } }));
    }
  }, {
    key: 'renderDefault',
