...
var Screen = function (_Core$Screen) {
  ...
  function Screen(props) {
    ...
    _this.state = _extends({}, _this.state, { progress: true, progressTitle: _this.progressTitle, height: 0, width: 0, scroll: 0 });
  ...
  _createClass(Screen, [{
    ...
    value: function loadComponent(name, index) {
      ...
      return _react2.default.createElement(
        ...
        this.props.components[name].map(function (props) {
          return _this5.loadSingleComponent(Object.assign({}, props, { key: 'component.' + subIndex++, index: index + '.' + subIndex }));
        })
      );
    }
  }, {
    ...
    value: function redirect(pathname) {
      return _react2.default.createElement(_reactRouter.Redirect, { exact: true, push: true, to: {
          pathname: pathname
        } });
    }
  }, {
