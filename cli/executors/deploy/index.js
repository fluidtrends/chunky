...
//   //  If we want to deploy the web, let's do that first
//   var chain = (index.web ? web(providers, deployment) : Promise.resolve())
//
...
//     command.artifacts = ['web']
//   }
//   var artifacts = command.artifacts.filter(artifact => (artifact === 'web' || artifact === 'functions'))
